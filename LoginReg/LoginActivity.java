package com.infobox.pratyushshivam.IndiaFirst.IndiaFirst.LoginReg;
...
import com.infobox.pratyushshivam.IndiaFirst.IndiaFirst.ForgotPassword.ForgotPassActivity;
import com.infobox.pratyushshivam.IndiaFirst.IndiaFirst.Home.MainActivity;
...
public class LoginActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        copyrightTV.setText("India First © " + year);
    ...
    private void loginUserAccount(String email, String password) {
        ...
        if(TextUtils.isEmpty(email)){
            ...
            SweetToast.error(this, "Your passwords needs to be greater than 6.");
        } else {
            //progress bar
                    ...
                    .addOnCompleteListener(new OnCompleteListener<AuthResult>() {
                        ...
                        public void onComplete(@NonNull Task<AuthResult> task) {
                            ...
                            if (task.isSuccessful()){
                                ...
                                SweetToast.error(LoginActivity.this, "Your email and password may be incorrect. Please try again.");
                            }
    ...
    private void checkVerifiedEmail() {
        ...
        if (isVerified){
            ...
            SweetToast.info(LoginActivity.this, "Email is not verified.");
            mAuth.signOut();
        }
    }
