package com.infobox.pratyushshivam.IndiaFirst.IndiaFirst.About;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        gitBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Uri uri = Uri.parse("https://github.com/pratyushshivam");
        ...
        InstaBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Uri uri = Uri.parse("https://instagram.com/pratyushshivam");
                Intent intent = new Intent(Intent.ACTION_VIEW, uri);
                startActivity(intent);
            }
        });
        ...
        LinBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Uri uri = Uri.parse("https://linkedin.com/in/pratyushshivam");
                Intent intent = new Intent(Intent.ACTION_VIEW, uri);
                startActivity(intent);
            }
        });
        ...
        TwBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Uri uri = Uri.parse("https://twitter.com/pratyushshivam");
                Intent intent = new Intent(Intent.ACTION_VIEW, uri);
                startActivity(intent);
            }
        });
