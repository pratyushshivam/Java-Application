package com.infobox.pratyushshivam.IndiaFirst.IndiaFirst.Chat;
...
import com.infobox.pratyushshivam.IndiaFirst.IndiaFirst.Model.Message;
import com.infobox.pratyushshivam.IndiaFirst.IndiaFirst.R;
import com.infobox.pratyushshivam.IndiaFirst.IndiaFirst.Adapter.MessageAdapter;
import com.infobox.pratyushshivam.IndiaFirst.IndiaFirst.Utils.UserLastSeenTime;
                ...
                public void onComplete(@NonNull Task<Uri> task) {
                    if (task.isSuccessful()){
                        if (task.isSuccessful()){
                            ...
                            Toast.makeText(ChatActivity.this, "Image was sent", Toast.LENGTH_SHORT).show();
